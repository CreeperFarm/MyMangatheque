...
class MentionsLegalesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(localizations.legalNotice)),
      body: Padding(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                subPart(
                  "2 - ${localizations.applicableLawAndCompetentJurisdiction} :",
                ),
                paragraph(
                  localizations.applicableLawAndCompetentJurisdictionLane1,
                ),
                subPart(
                  "${localizations.lastUpdateDate} : ${DateFormat.yMMMMd(localizations.localeName).format(DateTime.utc(2023, 12, 13))}",
                ),
              ],
            ),
          ),
